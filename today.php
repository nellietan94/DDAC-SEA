...
<html>
<head>
	<title>Maersk Line - Southeast Asia - Today's Inbound and Outbound</title>
	<meta charset="utf-8">
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<p class="navbar-text" style="color:#008eff;"><small>Southeast Asia</small></p>
	...
	<div class="footer">
		<img class="footer-brand" src="img/logo-colored.png"> THE MAERSK GROUP ALL RIGHTS RESERVED 2017 - SOUTHEAST ASIA
	</div>
</body>
</html>